...
class DatasAbertas(models.Model):
    ...
    # esse user faz relacao com a tabela usuario (com o user que esta logado) e o 
    # on_delete diz que se o medico deletar essa data aberta, nao acontece nada com o usuarios
    user = models.ForeignKey(User, on_delete=models.DO_NOTHING) 
